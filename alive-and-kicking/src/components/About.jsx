    ...
    <Section id="about" title="Our Story" className="bg-amber-100" titleClassName="text-slate-800">
      ...
      <div className="grid gap-8 lg:grid-cols-2 items-center">
        ...
        >
          ...
          >
            <p className="text-lg leading-relaxed text-amber-100" style={{ fontFamily: "Georgia, serif" }}>
            ...
            <p className="mt-4 text-lg leading-relaxed text-amber-100" style={{ fontFamily: "Georgia, serif" }}>
