...
export function LocationHours() {
  return (
    <Section id="location" title="Hours & Location" className="bg-slate-800" titleClassName="text-white">
      {/* Decorative divider */}
      <div className="flex items-center justify-center gap-4 -mt-4 mb-8">
        <div className="h-px flex-1 max-w-20 bg-gradient-to-r from-transparent to-slate-500" />
        <span className="text-amber-400 text-2xl">&#9733;</span>
        <div className="h-px flex-1 max-w-20 bg-gradient-to-l from-transparent to-slate-500" />
      </div>
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        <div className="space-y-6">
          {/* Hours */}
          <div className="rounded-2xl bg-slate-900 p-6 shadow-lg ring-1 ring-white/10">
            <h3 className="mb-4 text-xl font-bold text-white uppercase tracking-wide flex items-center gap-2">
            ...
            <div className="space-y-3 text-slate-300">
              ...
              {contactInfo.hours.note && (
                <p className="mt-4 text-slate-400 italic text-sm border-t border-slate-700 pt-3">
                  {contactInfo.hours.note}
                </p>
              )}
            </div>
          ...
          <div className="rounded-2xl bg-slate-900 p-6 shadow-lg ring-1 ring-white/10">
            ...
            <div className="space-y-3 text-slate-300">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 mt-4 px-5 py-2.5 bg-red-700 text-white rounded-full text-sm sm:text-base font-medium hover:bg-red-600 transition-colors shadow-md"
              >
        ...
        {/* Right Column - Map */}
        <div className="rounded-2xl overflow-hidden shadow-lg ring-1 ring-white/10 h-full min-h-[300px] md:min-h-[400px]">
          <iframe
